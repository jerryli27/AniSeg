...
_ADAMOPTIMIZER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='adam_beta1', full_name='object_detection.protos.AdamOptimizer.adam_beta1', index=1,
      number=2, type=2, cpp_type=6, label=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='adam_beta2', full_name='object_detection.protos.AdamOptimizer.adam_beta2', index=2,
      number=3, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='adam_epsilon', full_name='object_detection.protos.AdamOptimizer.adam_epsilon', index=3,
      number=4, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
